...
export function TopMenu ({ introRef, presentationRef, electricRef, outsideRef, insideRef, contactRef, lang  }) {
    ...
    <>
      ...
      <header className='tesla-top-menu'>
        ...
        <div className='sections'>
          ...
          <button onClick={() => handleScroll(presentationRef)}>{lang.presentation}</button>
          <button onClick={() => handleScroll(electricRef)}>{lang.electricSystem}</button>
          <button onClick={() => handleScroll(outsideRef)}>{lang.outside}</button>
          <button onClick={() => handleScroll(insideRef)}>{lang.inside}</button>
          <button onClick={() => handleScroll(contactRef)}>{lang.contact}</button>
        </div>
